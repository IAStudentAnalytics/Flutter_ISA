...
Future<List<TestInfo>> getAllTests() async {
  final response =
      await http.get(Uri.parse('http://192.168.1.54:5000/test/getAllTests'));
...
Future<List<Question>> getQuestionsByTestId(String? testId) async {
  ...
  final response =
      await http.get(Uri.parse('http://192.168.1.54:5000/test/tests/$testId/'));
...
Future<List<String>> getChaptersByTestId(String testId) async {
  final response = await http
      .get(Uri.parse('http://192.168.1.54:5000/test/tests/$testId/chapters'));
