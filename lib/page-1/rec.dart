...
class _RecommendedVideosPageState extends State<RecommendedVideosPage> {
  ...
  Future<void> fetchRecommendedVideos() async {
    ...
    final String testId = '66259a8177b0e5198289f765';  // This could be dynamically defined as well

    final response = await http.get(Uri.parse('http://192.168.1.17:5000/note/rec/$testId/$studentId'));
